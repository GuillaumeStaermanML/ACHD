...
FIF0 = FIF.FIForest(X, time=times, innerproduct='auto', D='cosinus', alpha = 0)
un_FIF0 = 1 - FIF0.compute_paths(X)
FIF1 = FIF.FIForest(X1, time=times, innerproduct='auto', D='cosinus', alpha = 0)
un_FIF1 = 1 - FIF1.compute_paths(X)
FIF2 = FIF.FIForest(X2, time=times, innerproduct='auto', D='cosinus', alpha = 0)
un_FIF2 = 1 - FIF2.compute_paths(X)
FIF3 = FIF.FIForest(X3, time=times, innerproduct='auto', D='cosinus', alpha = 0)
un_FIF3 = 1 - FIF3.compute_paths(X)
FIF4 = FIF.FIForest(X4, time=times, innerproduct='auto', D='cosinus', alpha = 0)
un_FIF4 = 1 - FIF4.compute_paths(X)
FIF5 = FIF.FIForest(X5, time=times, innerproduct='auto', D='cosinus', alpha = 0)
...
with open("xp_robu_repetition10_3.csv", "w") as f_write:
